...
public class ShopRepository {
    ...
    public Product findById(int productIdToFind) {
        for (Product product : products) {
            if (product.getId() == productIdToFind) {
                return product;
            }
        }
        return null;
    ...
    public void removeById(int productIdToRemove) {
        if (findById(productIdToRemove) == null) {
            throw new NotFoundException("Product with ID = " + productIdToRemove + " not found.");
        }
